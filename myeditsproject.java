...
class Greek_Card_Game {
  ...
  public static String playerTurn(String playerName, ArrayList<String> playerHand, ArrayList<String> discard, ArrayList<String> draw, Scanner scnr, String refCard) {
    ...
    */
    ...
    playerChoice = JOptionPane.showOptionDialog(null, "The top card is "+ discard.get(0)+".","What would you like to do?", JOptionPane.DEFAULT_OPTION,
    ...
    actionOptions, actionOptions[0]);// asking the questions
      if(playerChoice == 0) {
        ...
        String playedCard = JOptionPane.showOptionDialog(null, "What card would you like to play?",Arrays.toString(playerHand), JOptionPane.DEFAULT_OPTION,
        JOptionPane.QUESTION_MESSAGE, null,
  ...
  public static void main(String[] args) {
    ...
    while(true) {
      ...
      for (int i = 0; i < numPlayers; i++) {
        JOptionPane.showMessageDialog(null, "Player " + (i+1) + " Name: ");
        String name = Integer.parseString(JOptionPane.showInputDialog(
